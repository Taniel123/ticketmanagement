            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-10">
                ...
                <div class="bg-white shadow-md rounded-xl p-4 sm:p-6 md:p-8 border border-gray-200">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mt-6">
                        ...
                        <div class="bg-white rounded-lg shadow-sm p-4 sm:p-6 border border-gray-200">
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <span
                                        class="text-xl sm:text-2xl font-bold text-gray-900">{{ $pendingUsers->total() }}</span>
                        ...
                        <div class="bg-white rounded-lg shadow-sm p-4 sm:p-6 border border-gray-200">
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <span
                                        class="text-xl sm:text-2xl font-bold text-gray-900">{{ \App\Models\User::where('role', 'admin')->count() }}</span>
                    ...
                    <div class="bg-white rounded-lg shadow-lg mt-5 px-5 py-3 border border-gray-200">
                        ...
                        <div class="mb-6">
                            <div
                                class="flex flex-col md:flex-row items-start md:items-center justify-between pb-4 border-b border-gray-200">
                                <div>
