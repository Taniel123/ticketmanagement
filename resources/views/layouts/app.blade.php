                ...
                <div class="flex items-center justify-between h-16">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <button id="sidebarToggle"
                            class="lg:hidden text-gray-700 focus:outline-none transition-transform transform duration-200 hover:text-indigo-600 p-1 rounded-md hover:bg-gray-100">
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="hidden md:block text-xl font-light text-gray-600 ml-2">| Ticket Management
                                System</span>
                        </div>
                    </div>
                ...
                <div class="h-full flex flex-col">
                    ...
                    <nav class="flex-1 px-3 py-4 space-y-3 overflow-y-auto">
                        ...
                        <a href="#"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3 text-indigo-600" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
