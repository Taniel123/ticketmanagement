    ...
    <div class="max-w-md w-full relative bg-white p-8 rounded-xl shadow-xl overflow-hidden">
        ...
        <div class="relative">
            <div class="text-center mb-6">
                ...
                <h2 class="mt-4 text-3xl font-bold text-gray-800">Ticket System</h2>
            ...
            @if ($errors->any())
                <div class="rounded-lg bg-red-50 p-4 mb-6 border-l-4 border-red-500">
                    <div class="flex">
                ...
                <div>
                    ...
                    <div class="relative rounded-md">
                        ...
                        <input id="email" name="email" type="email" autocomplete="email" required 
                            class="appearance-none block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 sm:text-sm"
